package com.damir.popravljanje.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.damir.popravljanje.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.damir.popravljanje.repository.UserRepository.USERS_BY_EMAIL_CACHE);
